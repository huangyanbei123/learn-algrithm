...
export class StringList {
    ...
    * @return 字符串缓冲
    */
   public append(p1: any, p3: any, p2: any): StringList {
      this.appendArray(arguments as any, 0, arguments.length);
      return this;
   }
    ...
    * @return 字符串缓冲
    */
   public appendArray(values: Array<any>, offset: number, count: number): StringList {
    ...
    * @return 字符串缓冲
    */
   public appendRepeat(value: string, count: number): StringList {
      var memory = this._memory;
      for (var i = 0; i < count; i++) {
         memory[this._count++] = value;
      }
